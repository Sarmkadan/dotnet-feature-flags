...
public static class DateTimeExtensionsValidation
{
    ...
    /// <returns>A list of human-readable validation problems; empty if valid.</returns>
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="startDate"/> or <paramref name="endDate"/> is null.</exception>
    ...
    /// <returns>A list of human-readable validation problems; empty if valid.</returns>
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="span"/> is null.</exception>
    ...
    public static bool IsValid(this DateTime? value) => value is not null && value.Validate().Count == 0;
    ...
    public static bool IsValidRange(this DateTime? startDate, DateTime? endDate) =>
        startDate is not null && endDate is not null && startDate.ValidateRange(endDate).Count == 0;
    ...
    /// <returns>True if valid; false otherwise.</returns>
    public static bool IsValid(this TimeSpan? span) => span is not null && span.Validate().Count == 0;
